...
const BuildProfile: React.FC = () => {
  ...
  // Debug logging
  console.log('BuildProfile component rendered:', {
    currentStage,
    themesLoading,
  ...
  if (themesLoading) {
    return (
      <div className="p-4 lg:p-8 min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
  ...
  return (
    <div className="p-4 lg:p-8 min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">No Themes Available</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                You need to add some themes before you can create LinkedIn posts. Visit the Themes page to get started.
              </p>
              <Button 
      ...
      {/* Main form - only show if themes are available */}
      {!themesLoading && userThemes.length > 0 && (
