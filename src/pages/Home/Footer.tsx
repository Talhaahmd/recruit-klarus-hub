        ...
        <div className="pt-16 pb-8 grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed text-sm">
              Revolutionizing recruitment with AI-powered talent matching and LinkedIn optimization.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/api-docs" className="text-muted-foreground hover:text-foreground transition-colors">API Documentation</Link></li>
            </ul>
          </div>
