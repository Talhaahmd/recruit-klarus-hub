  ...
  return (
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4">
        <div className="pt-16 pb-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
        ...
        <div className="py-6 border-t border-gray-700 flex flex-col md:flex-row md:items-center md:justify-between">
