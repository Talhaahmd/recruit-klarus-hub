            ...
            <div className="col-lg-3 col-xl-4">
              <div className="cs_footer_widget">
                <div className="cs_text_field">
                  <img src="https://res.cloudinary.com/dt93sahp2/image/upload/v1761244578/freepik__background__64708_1_ilskfj.png" alt="Logo" className="cs_footer_logo" style={{ height: '120px' }} />
